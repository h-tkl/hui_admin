<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\web\H-ui.admin\H-ui.admin\public/../application/admin\view\product\product-list.html";i:1530927614;s:69:"D:\web\H-ui.admin\H-ui.admin\application\admin\view\common\blank.html";i:1530927614;s:70:"D:\web\H-ui.admin\H-ui.admin\application\admin\view\common\footer.html";i:1530927614;}*/ ?>
﻿﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div style="margin-left:200px;">
	<nav class="breadcrumb">
		...
		产品列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" >
		<i class="Hui-iconfont">&#xe68f;</i>
		</a>
	</nav>
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
				...
				<a class="btn btn-primary radius" onclick="product_add('添加产品','<?php echo url('admin/product/add'); ?>')" href="javascript:;">
					<i class="Hui-iconfont">&#xe600;</i>
					添加产品</a>
			</span>
